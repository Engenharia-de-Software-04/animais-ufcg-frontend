      ...
      <div className="sections">
        ...
        <section className="section-3">
          ...
          <div className="container-help">
            <div className="box-3">
              <p>
                Ajude a proteger os animais que vivem no campus da UFCG! Seja
                voluntário na nossa ONG e faça a diferença na vida desses
                animais. Contribua com cuidados, resgates, campanhas educativas
                e eventos de adoção.Toda ajuda é valiosa!
                <br />
                <br />
